...
export const PAGE_META = {
  ...
  editorial: ["编辑部", "消息流、任务板、关系网与每人今日：看看编辑们今天都在忙什么"],
...
export function Topbar({ page, now, error, refreshing, refresh }) {
    ...
    <div className="modal-mask" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal confirm-modal">
        <div className="modal-head">
          ...
          <button className="btn !px-2 !py-0.5 text-sm" onClick={onClose}>✕</button>
        </div>
