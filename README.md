...
当前状态：**已真实跑通端到端发布**——《殡仪馆的规矩》已在番茄上线
（第 1/2 章，2026-08-11）。仓库：https://github.com/ppepperkok-hue/novel-pipeline
...
环境要求：Python 3.9+、Node.js 18+、n8n 2.8（自托管）、番茄小号（已实名）。
...
- **电脑深夜断电**：本机从 2026-08-05 起多次凌晨意外断电（非代码问题），
  会中断运行中的执行（标记 crashed）；建议检查电源/散热，必要时调整
  日更时间避开凌晨；
