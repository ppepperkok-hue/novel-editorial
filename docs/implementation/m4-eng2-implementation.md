...
- 暂不做：向量、评分排序、跨作品索引。
- 状态：已完成（8b0541c + 修复链 ff95a36→9cdc194，2026-08-14）。双路径一致性守卫（含非 ASCII 大小写）、运行时探测、回退 LIKE、残留自愈全部闭合；审查链 Ready to merge。

### B0. M4-ENG-2 收口

- 已完成（2026-08-14）：全链总审 + 修复链 6 轮收敛；审查报告归档 docs/reviews/20260814-M4-ENG2-initial.md / -fix.md；基线更新 docs/verification/m4-eng2-closeout.md；收口提交即推。
